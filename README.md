...
## Chatbot Interativo com TypeScript, Next.js e Angular

Este projeto apresenta um chatbot interativo construído utilizando **TypeScript** para a lógica e funcionalidades, **Next.js** para a estrutura e renderização do frontend, e **Angular** para componentes específicos da interface do usuário. O chatbot oferece uma experiência de conversação dinâmica e responsiva, combinando o poder de diferentes frameworks para um resultado robusto.
...
Este chatbot serve como um colega que sempre esta pronto para te ajudar com respostas claras e objetivas.Sinta-se à vontade para explorar o código e contribuir!
